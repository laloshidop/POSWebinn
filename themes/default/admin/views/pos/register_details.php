    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table width="100%" class="stable">
                ...
                <tr>
                    <td style="border-top: 1px solid #DDD;"><h4><?= lang('Cash Refunds'); ?>:</h4></td>
                    <td style="text-align:right;border-top: 1px solid #DDD;"><h4>
                            <span style="font-weight:bold;"><?= $this->sma->formatMoney($cashrefunds->returned ? $cashrefunds->returned : '0.00') . ' (' . $this->sma->formatMoney($cashrefunds->total ? $cashrefunds->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="border-top: 1px solid #DDD;"><h4><?= lang('expenses'); ?>:</h4></td>
                    <td style="text-align:right;border-top: 1px solid #DDD;"><h4>
                ...
                <tr>
                    ...
                    <td style="text-align:right;border-top: 1px solid #DDD;"><h4>
                            <span><strong><?= $cashsales->paid ? $this->sma->formatMoney(($cashsales->paid + ($this->session->userdata('cash_in_hand'))) + ($cashrefunds->returned ? $cashrefunds->returned : 0) - ($returns->total ? $returns->total : 0) - $expense) : $this->sma->formatMoney($this->session->userdata('cash_in_hand') - $expense - ($returns->total ? $returns->total : 0)); ?></strong></span>
                        </h4></td>
                </tr>
            </table>
        </div>
